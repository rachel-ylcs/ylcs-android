...
data class RachelTab(
    ...
    companion object {
        ...
        val world = RachelTab(0, FragmentWorld::class.java, "世界", R.drawable.world_normal, R.drawable.world_active)
        val msg = RachelTab(1, FragmentMsg::class.java, "资讯", R.drawable.msg_normal, R.drawable.msg_active)
        val music = RachelTab(2, FragmentMusic::class.java, "听歌", R.drawable.music_normal, R.drawable.music_active)
        val discovery = RachelTab(3, FragmentDiscovery::class.java, "发现", R.drawable.discovery_normal, R.drawable.discovery_active)
